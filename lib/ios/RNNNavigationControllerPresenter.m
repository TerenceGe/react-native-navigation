...
- (void)applyOptions:(RNNNavigationOptions *)options {
	...
	[navigationController rnn_setRightImage:[options.topBar.rightImage getWithDefaultValue:nil]];
...
- (void)mergeOptions:(RNNNavigationOptions *)newOptions currentOptions:(RNNNavigationOptions *)currentOptions defaultOptions:(RNNNavigationOptions *)defaultOptions {
	...
	if (newOptions.topBar.rightImage.hasValue) {
		[navigationController rnn_setRightImage:newOptions.topBar.rightImage.get];
	}
